...
export interface paths {
    ...
    "/v1/investigations/{id}/kb": {
        ...
        get?: never;
        put?: never;
        post: operations["saveInvestigationToKB"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/session": {
        ...
        /** @description Exchanges the session cookie for the token it holds. An invalid cookie is cleared and answers 204, never 401. */
        get: operations["readSession"];
        put?: never;
        /** @description Verifies the presented bearer token and sets it as an httpOnly, SameSite=Strict cookie scoped to this path alone, so a console reload can restore its session without a credential in web storage. */
        post: operations["createSession"];
        /** @description Clears the session cookie. Requires no live credential. */
...
export interface operations {
    ...
    saveInvestigationToKB: {
        ...
        requestBody?: never;
        responses: {
            /** @description Draft article created */
            201: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["SaveInvestigationToKBResponse"];
                };
            };
            401: components["responses"]["Unauthorized"];
            404: components["responses"]["NotFound"];
    ...
    readSession: {
        ...
        responses: {
            ...
            /** @description No restorable session */
            204: {
                headers: {
                    [name: string]: unknown;
                };
